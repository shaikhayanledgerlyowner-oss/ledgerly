...
export default function InvoicesPage() {
  ...
  const downloadPDF = async (doc: any) => {
    try {
      ...
      // --- HEADER WRAP FIX: compute header height based on wrapped text ---
      const rightBlockW = 210; // space reserved for title/date/no
      const leftMargin = 40;
      const rightMargin = 40;

      const leftX = logoDataUrl ? 110 : 40; // text start after logo
      const leftMaxW = pageW - rightMargin - rightBlockW - 20 - leftX; // ✅ wrap within available width
      ...
      for (const line of businessLinesWrapped) {
        ...
        curY += headerLineH;
        // prevent accidental overflow into title area
      ...
      // ✅ REMOVE PAYMENT DETAILS — nothing
